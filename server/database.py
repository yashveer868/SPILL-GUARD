...
def save_feedback(name: Optional[str], email: Optional[str], feedback_type: str, rating: int, message: str) -> Dict[str, Any]:
    conn = get_connection()
    cursor = conn.cursor()
    cursor.execute(
        """
        ...
        VALUES (%s, %s, %s, %s, %s)
        RETURNING id, name, email, feedback_type, rating, message, created_at
        """,
